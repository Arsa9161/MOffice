...
const relatedPlacesList = [
  ...
  {
    id: "7",
    hotelImage: require("../../assets/images/room/room_7.jpg"),
  ...
  {
    id: "8",
    hotelImage: require("../../assets/images/room/room_8.jpg"),
...
const MustVisitPlaceScreen = ({ navigation, route }) => {
  ...
  function showAllReviewsButton() {
    return (
      ...
      >
        <Text style={{ ...Fonts.primaryColor18Regular }}>Show all reviews</Text>
      </TouchableOpacity>
    );
  }
  ...
  function location() {
    return (
      <View style={styles.mapStyle}>
        <GoogleMap latitude={47.8864} longitude={106.9057} height={270} />
      </View>
    );
  }
