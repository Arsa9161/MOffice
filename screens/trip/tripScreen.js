...
const TripScreen = ({ navigation }) => {
  return (
    <View style={{ flex: 1 }}>
      ...
      <ImageBackground
        source={require("../../assets/images/ub_city.jpg")}
        style={{ flex: 1 }}
      >
        <LinearGradient
          start={{ x: 0, y: 0 }}
        ...
        >
          ...
          >
            Өөрт хэрэгтэй оффис өрөөгөө түрээслээрэй
          </Text>
          <TouchableOpacity
            activeOpacity={0.9}
          ...
          >
            <Text style={{ ...Fonts.primaryColor19Regular }}>Өрөө хайх</Text>
          </TouchableOpacity>
        </LinearGradient>
      </ImageBackground>
    </View>
