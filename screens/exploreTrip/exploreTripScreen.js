...
const placeImagesList = [
  {
    image: require("../../assets/images/room/room_6.jpg"),
  },
  {
    image: require("../../assets/images/room/room_5.jpg"),
  },
  {
    image: require("../../assets/images/room/room_4.jpg"),
  },
];
...
const popularDestinationsList = [
  {
    id: "1",
    destinationImage: require("../../assets/images/popular_places/talbai.jpg"),
    destinationName: "Талбай",
  },
  {
    id: "2",
    destinationImage: require("../../assets/images/popular_places/zaisan.jpg"),
    destinationName: "Зайсан",
  },
  {
    id: "3",
    destinationImage: require("../../assets/images/popular_places/13.jpg"),
    destinationName: "13-р хороолол",
  },
  {
    id: "4",
    destinationImage: require("../../assets/images/popular_places/khanuul.jpg"),
    destinationName: "Хан-Уул",
  },
];
  ...
  function header() {
    return (
      <View style={styles.headerWrapStyle}>
        <Text style={{ ...Fonts.blackColor20Regular }}>Оффис өрөөнүүд</Text>
        <MaterialIcons
          name="arrow-back"
          size={24}
          color="black"
