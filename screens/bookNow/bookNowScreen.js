...
const BookNowScreen = ({ navigation, route }) => {
    ...
    return (
      <View style={styles.ruleInfoWrapStyle}>
        ...
        {rule({
          ...
          rule: "эхлэх цагаас хоцрохгүй байх",
        })}
        {rule({
          icon: (
            <MaterialCommunityIcons
          ...
          rule: "дуусах цагаас хоцрохгүй байх",
        })}
        {rule({
          icon: (
            <MaterialCommunityIcons name="door-open" size={17} color="black" />
          ),
          rule: "Эд хөрөнгө гэмтээхгүй байх",
        })}
        {rule({
          icon: (
            <MaterialCommunityIcons
          ...
          rule: "Тамхи татах хориотой",
        })}
        {rule({
          icon: <MaterialIcons name="pets" size={17} color="black" />,
          rule: "Амьтан орохыг хориглоно",
        })}
      </View>
    );
  }
  ...
  function selectStartDateDialog() {
    return (
      <Dialog
        visible={showStartDateSelection}
        style={{ borderRadius: Sizes.fixPadding }}
      >
        <View style={styles.selectDateWrapStyle}>
          <Text style={{ ...Fonts.whiteColor14Regular }}>SELECTD DATE</Text>
  ...
  function selectDateInfo() {
    return (
      <View style={styles.selectDateInfoWrapStyle}>
        <View style={{ flexDirection: "row" }}>
          <Text style={{ ...Fonts.blackColor20Bold }}>{amount}к</Text>
          <Text
            style={{
              ...Fonts.blackColor16Regular,
              alignSelf: "flex-end",
        ...
        <View style={{ flexDirection: "row", alignItems: "center" }}>
          ...
          >
            2 цагаар захиалвал 1 цаг үнэгүй
          </Text>
        </View>
        ...
        <View style={styles.startToEndDateWrapStyle}>
          <View style={{ alignItems: "center" }}>
            ...
            <Text style={{ ...Fonts.grayColor16Regular }}>ээс</Text>
            <Text style={{ ...Fonts.blackColor18Regular }}>
              {selectedEndDateDay == ""
                ? `${year}-${finalMonth}-${date + 1}`
                : isViewSelectedEndDate
