...
const VerificationScreen = ({ navigation }) => {
  ...
  function submitButton() {
    return (
      ...
      >
        ...
        >
          <Text style={{ ...Fonts.whiteColor17Regular }}>Баталгаажуул</Text>
        </LinearGradient>
      </TouchableOpacity>
    );
  }
  ...
  function resendInfo() {
    return (
      ...
      >
        <Text style={{ ...Fonts.grayColor16Regular }}>Надад код ирсэнгүй!</Text>
        <Text
          style={{
  ...
  function verificationInfo() {
    return (
      ...
      >
        <Text style={{ ...Fonts.whiteColor30Bold }}>Баталгаажуулна уу</Text>
        <Text
          style={{
        ...
        >
          Таны утасны дугаарт илгээсэн баталгаажуулах кодыг оруулна уу
        </Text>
      </View>
    );
  }
